...
export class CustomReuseStrategy implements RouteReuseStrategy {
  ...
  /**
   * This nasty bugger finds out whether the objects are _traditionally_ equal to each other, like you might assume someone else
   * would have put this function in vanilla JS already
